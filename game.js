...
//20.You'll need a way to keep track of whether if the game has started or not, so you only call nextSequence() on the first keypress.
var started = false;
...
function nextSequence() {
 ...
 //8. Use Google/Stackoverflow to figure out how you can use jQuery to animate a flash to the button selected in step 1.
  ...
  //go to this link: https://github.com/tannuchoudhary/WebDev/blob/main/4.JAVASCRIPT/2.%20ADVANCED_JAVASCRIPT/2.play_sound.md
